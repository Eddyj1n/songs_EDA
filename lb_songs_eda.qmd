...
The below EDA motivates the following

mODELS FRAMEWORK:

dATA aSSUMPTIONS:

- Consider log transforming the target if we using statistical model, for model A random forest, probably won't make too much of difference as it's a tree based model. 
